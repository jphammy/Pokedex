...
class EditPokemonTableViewController: UITableViewController {
    ...
    private func validateInputs() {
        ...
        }// Nickname must be at least 3 char and not blank
         // Current level and experience must contain a char
            ...
            if self.heldItemLabel.text! == "Select held item" {
                ...
                heldItem = self.heldItemLabel.text!
            }
            caughtPokemon = CaughtPokemon(collectionId: uniqueID, id: selectedSpeciesID!, species: self.speciesLabel.text!, nickName: self.nickNameTextField.text!, currentLevel: Int(self.currentLevelTextField.text!)!, currentExperience: Int(self.currentExperienceTextField.text!)!, moves: self.selectedMoves!, heldItem: heldItem, sprite: self.selectedSprite!)
...
// Reference: https://medium.com/ios-os-x-development/a-better-exhaustive-switch-in-uitableview-protocols-c770200c9ffa
// https://stackoverflow.com/questions/35945923/switch-that-checks-nsindexpaths-row-and-section
extension EditPokemonTableViewController {
...
// Reference: https://www.hackingwithswift.com/read/9/4/back-to-the-main-thread-dispatchqueuemain
